        ...
        return (
          ...
          >
            ...
            <div className="flex w-full flex-col gap-2 self-start">
              ...
              {isCustomRate ? (
                <div className="mt-1 flex w-full items-center gap-2 rounded-full border border-slate-100/80 bg-slate-50 px-2.5 py-1 text-[11px] text-slate-500 shadow-inner">
                  ...
                  <button
                    ...
                    className="rounded-full border border-slate-200 bg-white px-2 py-0.5 text-[11px] font-medium text-slate-600 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-300"
                  >
                    Reset
                  </button>
                </div>
